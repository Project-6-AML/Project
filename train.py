...
import losses.sphereface as sphereface
...
#### Model
model = network.GeoLocalizationNet(args.backbone, args.fc_output_dim, args.self_attention, args.reranking)
...
groups = [TrainDataset(args, args.train_set_folder, M=args.M, alpha=args.alpha, N=args.N, L=args.L,
                       current_group=n, min_images_per_class=args.min_images_per_class, data_aug_tag=args.data_aug_tag, data_aug_perc=args.data_aug_perc) for n in range(args.groups_num)]
